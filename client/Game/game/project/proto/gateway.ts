...
const encodeCMD: { [key: string]: number } = {
  none: 0,
  error_a: 10000,
  auth_r: 10001,
  auth_a: 10002,
...
function GetID(str: string): number {
  return encodeCMD[str];
}

const decodeCMD: { [key: number]: CMD } = {
  0: CMD.none,
  10000: CMD.error_a,
  10001: CMD.auth_r,
  10002: CMD.auth_a,
...
class error_a implements Message {
  cmd?: number;
  code?: number;
  _name(): string {
    return "error_a";
...
function encodeerror_a(message: error_a): Uint8Array {
...
function decodeerror_a(binary: Uint8Array): error_a {
...
class auth_r implements Message {
  account?: string;
  password?: string;
  _name(): string {
    return "auth_r";
...
function encodeauth_r(message: auth_r): Uint8Array {
  let bb = popByteBuffer();
...
function decodeauth_r(binary: Uint8Array): auth_r {
...
class auth_a implements Message {
  _name(): string {
    return "auth_a";
  }
}

function encodeauth_a(message: auth_a): Uint8Array {
  let bb = popByteBuffer();
...
function decodeauth_a(binary: Uint8Array): auth_a {
...
function encodeserver(message: server): Uint8Array {
  let bb = popByteBuffer();
...
function _encodeserver(message: server, bb: ByteBuffer): void {
  ...
  let $server_name = message.server_name;
  if ($server_name !== undefined) {
    writeVarint32(bb, 18);
    writeString(bb, $server_name);
  }

  // optional int64 open_time = 3;
  let $open_time = message.open_time;
  if ($open_time !== undefined) {
    writeVarint32(bb, 24);
    writeVarint64(bb, $open_time);
  }
...
function decodeserver(binary: Uint8Array): server {
...
function _decodeserver(bb: ByteBuffer): server {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string server_name = 2;
      case 2: {
        message.server_name = readString(bb, readVarint32(bb));
        break;
      }

      // optional int64 open_time = 3;
      case 3: {
        message.open_time = readVarint64(bb, /* unsigned */ false);
        break;
      }
...
class servers_r implements Message {
  _name(): string {
    return "servers_r";
  }
}

function encodeservers_r(message: servers_r): Uint8Array {
  let bb = popByteBuffer();
...
function decodeservers_r(binary: Uint8Array): servers_r {
...
class servers_a implements Message {
  ret?: number;
  list?: server[];

}

function encodeservers_a(message: servers_a): Uint8Array {
  let bb = popByteBuffer();
...
function decodeservers_a(binary: Uint8Array): servers_a {
...
class login_r implements Message {
  server_id?: number;
  _name(): string {
    return "login_r";
  }
...
function encodelogin_r(message: login_r): Uint8Array {
  let bb = popByteBuffer();
...
function decodelogin_r(binary: Uint8Array): login_r {
...
class login_a implements Message{
  code?: number;
  uid?: Long;
  _name(): string {
    return "login_a";
...
function encodelogin_a(message: login_a): Uint8Array {
  let bb = popByteBuffer();
...
function decodelogin_a(binary: Uint8Array): login_a {
...
function encodecreate_r(message: create_r): Uint8Array {
  let bb = popByteBuffer();
...
function decodecreate_r(binary: Uint8Array): create_r {
...
function encodecreate_a(message: create_a): Uint8Array {
  let bb = popByteBuffer();
...
function decodecreate_a(binary: Uint8Array): create_a {
...
export function encode(cmd: string, body: Object) : Uint8Array {
  let id = GetID(cmd);
  switch (cmd) {
  case CMD.auth_r: return encodeauth_r(body as auth_r);
  case CMD.auth_a: return encodeauth_a(body as auth_a);
  case CMD.servers_r: return encodeservers_r(body as servers_r);
  case CMD.servers_a: return encodeservers_a(body as servers_a);
  case CMD.login_r: return encodelogin_r(body as login_r);
  case CMD.login_a: return encodelogin_a(body as login_a);
  case CMD.create_r: return encodecreate_r(body as create_r);
  case CMD.create_a: return encodecreate_a(body as create_a);
  default: throw new Error(`Unknown command: ${cmd}`);
  }
}

export function decode(id: number, binary: Uint8Array) : Object {
  let cmd = decodeCMD[id];
  switch (cmd) {
  case CMD.auth_r: return decodeauth_r(binary);
  case CMD.auth_a: return decodeauth_a(binary);
  case CMD.servers_r: return decodeservers_r(binary);
  case CMD.servers_a: return decodeservers_a(binary);
  case CMD.login_r: return decodelogin_r(binary);
  case CMD.login_a: return decodelogin_a(binary);
  case CMD.create_r: return decodecreate_r(binary);
  case CMD.create_a: return decodecreate_a(binary);
  default: throw new Error(`Unknown command: ${cmd}`);
  }
}
